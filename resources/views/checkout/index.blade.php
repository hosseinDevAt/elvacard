                    ...
                    <div class="space-y-3">
                        @foreach ($cart['items'] as $item)
                            <div class="rounded border border-gray-100 p-3 text-sm">
                                ...
                                <p><span class="font-semibold">رنگ:</span> {{ $item['color_name_snapshot'] ?? $item['color_id'] }}</p>
                                <p><span class="font-semibold">طرح:</span> {{ $item['design_name_snapshot'] ?? $item['design_id'] }}</p>
